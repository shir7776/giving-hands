                ...
                <div className="login-box">
                    ...
                    <form >
                        <div className="user-box" >
                            <input type="text" name="title" id="title"  onChange={(e)=>(this.setState({title:e.target.value}))}required/>
                            <label>Title*</label>
                        </div>
                        <div className="user-box">

                            <input type="text" name="" required={true} onChange={(e)=>(this.setState({content:e.target.value}))}/>
                            <label>What Do Yo Want To Write About?*</label>
                        </div>
                        <div className="user-box">

                            <input type="text" name="" required={true} onChange={(e)=>(this.setState({userEmail:e.target.value}))}/>
                            <label>Your Email*</label>
                        </div>
                        <div className="user-box">

                            <input type="text" name="" required={true} onChange={(e)=>(this.setState({labels:e.target.value}))}/>
                        ...
                        <a >
                            ...
                            <span></span>
                            Add Ticket
                        </a><a onClick={this.newPostVisibility}>cancle</a>
                    </form>
                </div>
            </div>
        )
    ...
    return (
        <main>
            ...
            <body className='body2'>
                <header>
                <button onClick={this.newPostVisibility}>{"Add New Post"}</button>
                    { this.state.addPost ? <this.newPost /> : null }
            </header>
                <div>
        {	posts ? this.renderPosts(posts) : <h2>Loading..</h2>}
