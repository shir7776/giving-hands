...
module.exports = db => {
    ...
    let schema = new mongo.Schema({
        id_area: { type: String, required: true,unique: true, index: true },
    ...
    db.model('divisional-areas', schema); // if model name === collection name
    debug("divisional-areas model created");
};
